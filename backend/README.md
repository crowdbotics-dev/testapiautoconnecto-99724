...
## Project Structure
    ...
    ├── testapiautoconnecto_99724  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_99724`
...
2. Clone this repo and `cd testapiautoconnecto_99724`
